...
export default async function Page() {
  const cabinsCount: Cabin[] = await getCabins();
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            ...
            away from home. But it not just about the luxury cabins. It about
            the experience of reconnecting with nature and enjoying simple
            pleasures with family.
          </p>
          <p>
            Our {cabinsCount.length} luxury cabins provide a cozy base, but the
